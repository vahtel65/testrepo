<%@ Page Title="" Language="C#" MasterPageFile="~/Configuration/ConfigurationMaster.Master" AutoEventWireup="true" CodeBehind="Tree.aspx.cs" Inherits="Aspect.UI.Web.Configuration.Tree" %>
    ...
    <div id="MySplitter">
        <div id="TopPane">
            ...
            <asp:GridView ID="ProductGrid" runat="server" GridLines="Vertical" BorderColor="LightGray"
                AutoGenerateColumns="false" AllowSorting="false" AllowPaging="false" CssClass="type1"
                ...
                <Columns>
                    <asp:TemplateField ItemStyle-Width="5px">
                        <ItemTemplate>
                            ...
                            <asp:CheckBox ID="SelectCheckBox" Visible="false" BorderStyle="None" runat="server" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
