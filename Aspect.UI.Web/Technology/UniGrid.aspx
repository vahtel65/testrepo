<%@ Page Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="UniGrid.aspx.cs" Inherits="Aspect.UI.Web.Technology.UniGrid" Title="Untitled Page" %>
     ...
     <script type="text/javascript">
         $().ready(function() {
            ...
            <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">\
                  ...
                  <param name="source" value="UniGrid.xap"/>\
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainPlace" runat="server">
    <div class="ui-layout-center" style="padding: 0; height:100%;"></div>    
</asp:Content>
