<%@ Page Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="Applicability.aspx.cs" Inherits="Aspect.UI.Web.Technology.Applicability" Title="Untitled Page" %>
    ...
    <script type="text/javascript">
        $().ready(function() {
            ...
            <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="100%" height="100%">\
                  ...
                  <param name="source" value="Applicability.xap"/>\
