<%@ Page Title="" Language="C#" MasterPageFile="~/Popup/PopupMaster.Master" AutoEventWireup="true" CodeBehind="ProductSearch.aspx.cs" Inherits="Aspect.UI.Web.Popup.ProductSearch" %>
...
<div style="border-top:solid 1px black;width:100%;float:right">
    <div style="float:left;padding:15px 0px 0px 30px;">
        <asp:LinkButton ID="Clear" runat="server" Text="Очистить" OnClick="Clear_Click" />&nbsp;&nbsp;&nbsp;
    </div>    
