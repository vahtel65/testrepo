...
namespace Aspect.UI.Web.Json
{
    ...
    class SearchBuilder
    {
        ...
        public string Perform(SearchRequest searchRequest)
        {
            ...
            string from = "FROM Product inner join ProductProperty prpr on Product.ID=prpr.ProductID and prpr.PropertyID='BBE170B0-28E4-4738-B365-1038B03F4552' and prpr.value='1'\n";  //bvv120420
